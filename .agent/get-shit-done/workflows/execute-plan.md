...
1. Create .planning/ISSUES.md if doesn't exist (use `./.agent/get-shit-done/templates/issues.md`)
...
See ./.agent/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Use ./.agent/get-shit-done/templates/summary.md for structure.
...
For commit message conventions, see ./.agent/get-shit-done/references/git-integration.md
</step>
