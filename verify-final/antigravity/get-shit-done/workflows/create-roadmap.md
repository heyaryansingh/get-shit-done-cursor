...
1. verify-final/antigravity/get-shit-done/templates/roadmap.md
2. verify-final/antigravity/get-shit-done/templates/state.md
...
```bash
ls verify-final/antigravity/skills/expertise/ 2>/dev/null
```
...
Use template from `verify-final/antigravity/get-shit-done/templates/roadmap.md`.
...
Use template from `verify-final/antigravity/get-shit-done/templates/state.md`.
