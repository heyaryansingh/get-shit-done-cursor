...
1. Create .planning/ISSUES.md if doesn't exist (use `verify-final/antigravity/get-shit-done/templates/issues.md`)
...
See verify-final/antigravity/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Use verify-final/antigravity/get-shit-done/templates/summary.md for structure.
...
For commit message conventions, see verify-final/antigravity/get-shit-done/references/git-integration.md
</step>
