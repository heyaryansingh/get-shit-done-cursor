...
- @verify-final/cursor/get-shit-done/workflows/complete-milestone.md (main workflow)
- @verify-final/cursor/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
