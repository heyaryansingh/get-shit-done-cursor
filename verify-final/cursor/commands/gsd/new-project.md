...
@verify-final/cursor/get-shit-done/references/principles.md
@verify-final/cursor/get-shit-done/references/questioning.md
@verify-final/cursor/get-shit-done/templates/project.md
@verify-final/cursor/get-shit-done/templates/config.json
...
Present completion with next steps (see verify-final/cursor/get-shit-done/references/continuation-format.md):
