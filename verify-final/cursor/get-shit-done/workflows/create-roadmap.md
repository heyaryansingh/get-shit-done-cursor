...
1. verify-final/cursor/get-shit-done/templates/roadmap.md
2. verify-final/cursor/get-shit-done/templates/state.md
...
```bash
ls verify-final/cursor/skills/expertise/ 2>/dev/null
```
...
Use template from `verify-final/cursor/get-shit-done/templates/roadmap.md`.
...
Use template from `verify-final/cursor/get-shit-done/templates/state.md`.
