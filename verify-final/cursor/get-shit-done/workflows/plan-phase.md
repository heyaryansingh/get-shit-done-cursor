...
1. verify-final/cursor/get-shit-done/templates/phase-prompt.md
2. verify-final/cursor/get-shit-done/references/plan-format.md
3. verify-final/cursor/get-shit-done/references/scope-estimation.md
4. verify-final/cursor/get-shit-done/references/checkpoints.md
5. verify-final/cursor/get-shit-done/references/tdd.md
...
See `verify-final/cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See verify-final/cursor/get-shit-done/references/checkpoints.md for checkpoint structure.
</step>
...
See verify-final/cursor/get-shit-done/references/scope-estimation.md for complete guidance.
</step>
...
Use template from `verify-final/cursor/get-shit-done/templates/phase-prompt.md`.
...
**TDD candidates get dedicated plans.** If "Create price calculator with discount rules" warrants TDD, create a TDD plan for it. See `verify-final/cursor/get-shit-done/references/tdd.md` for TDD plan structure.
</task_quality>
