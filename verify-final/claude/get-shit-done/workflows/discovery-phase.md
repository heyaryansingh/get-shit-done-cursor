...
See verify-final/claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Quality check:** Before finalizing findings, consult verify-final/claude/get-shit-done/references/research-pitfalls.md to avoid common research gaps.

7. **Create DISCOVERY.md** using verify-final/claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using verify-final/claude/get-shit-done/templates/discovery.md:
...
6. **Quality check:** Before finalizing findings, consult verify-final/claude/get-shit-done/references/research-pitfalls.md to ensure comprehensive coverage and avoid common research gaps.

7. **Create comprehensive DISCOVERY.md:**

   - Full structure from verify-final/claude/get-shit-done/templates/discovery.md
...
Use verify-final/claude/get-shit-done/templates/discovery.md.
