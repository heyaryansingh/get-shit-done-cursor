...
1. Create .planning/ISSUES.md if doesn't exist (use `verify-final/claude/get-shit-done/templates/issues.md`)
...
See verify-final/claude/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Use verify-final/claude/get-shit-done/templates/summary.md for structure.
...
For commit message conventions, see verify-final/claude/get-shit-done/references/git-integration.md
</step>
