...
1. verify-final/claude/get-shit-done/templates/roadmap.md
2. verify-final/claude/get-shit-done/templates/state.md
...
```bash
ls verify-final/claude/skills/expertise/ 2>/dev/null
```
...
Use template from `verify-final/claude/get-shit-done/templates/roadmap.md`.
...
Use template from `verify-final/claude/get-shit-done/templates/state.md`.
