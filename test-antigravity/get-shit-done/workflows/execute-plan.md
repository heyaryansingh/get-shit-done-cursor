...
1. Create .planning/ISSUES.md if doesn't exist (use `test-antigravity/get-shit-done/templates/issues.md`)
...
See test-antigravity/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Use test-antigravity/get-shit-done/templates/summary.md for structure.
...
For commit message conventions, see test-antigravity/get-shit-done/references/git-integration.md
</step>
