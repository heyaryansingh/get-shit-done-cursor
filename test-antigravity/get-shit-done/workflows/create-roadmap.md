...
1. test-antigravity/get-shit-done/templates/roadmap.md
2. test-antigravity/get-shit-done/templates/state.md
...
```bash
ls test-antigravity/skills/expertise/ 2>/dev/null
```
...
Use template from `test-antigravity/get-shit-done/templates/roadmap.md`.
...
Use template from `test-antigravity/get-shit-done/templates/state.md`.
