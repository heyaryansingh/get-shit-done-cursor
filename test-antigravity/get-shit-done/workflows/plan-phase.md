...
1. test-antigravity/get-shit-done/templates/phase-prompt.md
2. test-antigravity/get-shit-done/references/plan-format.md
3. test-antigravity/get-shit-done/references/scope-estimation.md
4. test-antigravity/get-shit-done/references/checkpoints.md
5. test-antigravity/get-shit-done/references/tdd.md
...
See `test-antigravity/get-shit-done/references/tdd.md` for TDD plan structure.
...
See test-antigravity/get-shit-done/references/checkpoints.md for checkpoint structure.
</step>
...
See test-antigravity/get-shit-done/references/scope-estimation.md for complete guidance.
</step>
...
Use template from `test-antigravity/get-shit-done/templates/phase-prompt.md`.
...
**TDD candidates get dedicated plans.** If "Create price calculator with discount rules" warrants TDD, create a TDD plan for it. See `test-antigravity/get-shit-done/references/tdd.md` for TDD plan structure.
</task_quality>
