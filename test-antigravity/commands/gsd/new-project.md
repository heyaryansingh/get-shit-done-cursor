...
@test-antigravity/get-shit-done/references/principles.md
@test-antigravity/get-shit-done/references/questioning.md
@test-antigravity/get-shit-done/templates/project.md
@test-antigravity/get-shit-done/templates/config.json
...
Present completion with next steps (see test-antigravity/get-shit-done/references/continuation-format.md):
