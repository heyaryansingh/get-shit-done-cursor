...
1. ./.antigravity/get-shit-done/templates/roadmap.md
2. ./.antigravity/get-shit-done/templates/state.md
...
```bash
ls ./.antigravity/skills/expertise/ 2>/dev/null
```
...
Use template from `./.antigravity/get-shit-done/templates/roadmap.md`.
