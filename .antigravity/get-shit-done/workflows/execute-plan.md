...
1. Create .planning/ISSUES.md if doesn't exist (use `./.antigravity/get-shit-done/templates/issues.md`)
...
See ./.antigravity/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Use ./.antigravity/get-shit-done/templates/summary.md for structure.
...
For commit message conventions, see ./.antigravity/get-shit-done/references/git-integration.md
</step>
