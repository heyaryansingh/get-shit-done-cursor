...
1. Create .planning/ISSUES.md if doesn't exist (use `test-claude/get-shit-done/templates/issues.md`)
...
See test-claude/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Use test-claude/get-shit-done/templates/summary.md for structure.
...
For commit message conventions, see test-claude/get-shit-done/references/git-integration.md
</step>
