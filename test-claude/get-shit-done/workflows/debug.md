...
<references>
@test-claude/get-shit-done/references/debugging/debugging-mindset.md
@test-claude/get-shit-done/references/debugging/hypothesis-testing.md
@test-claude/get-shit-done/references/debugging/investigation-techniques.md
@test-claude/get-shit-done/references/debugging/verification-patterns.md
@test-claude/get-shit-done/references/debugging/when-to-research.md
</references>

<template>
@test-claude/get-shit-done/templates/DEBUG.md
</template>
