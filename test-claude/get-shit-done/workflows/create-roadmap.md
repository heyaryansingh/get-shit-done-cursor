...
1. test-claude/get-shit-done/templates/roadmap.md
2. test-claude/get-shit-done/templates/state.md
...
```bash
ls test-claude/skills/expertise/ 2>/dev/null
```
...
Use template from `test-claude/get-shit-done/templates/roadmap.md`.
...
Use template from `test-claude/get-shit-done/templates/state.md`.
