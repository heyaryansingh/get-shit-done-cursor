...
1. test-claude/get-shit-done/templates/phase-prompt.md
2. test-claude/get-shit-done/references/plan-format.md
3. test-claude/get-shit-done/references/scope-estimation.md
4. test-claude/get-shit-done/references/checkpoints.md
5. test-claude/get-shit-done/references/tdd.md
...
See `test-claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See test-claude/get-shit-done/references/checkpoints.md for checkpoint structure.
</step>
...
See test-claude/get-shit-done/references/scope-estimation.md for complete guidance.
</step>
...
Use template from `test-claude/get-shit-done/templates/phase-prompt.md`.
...
**TDD candidates get dedicated plans.** If "Create price calculator with discount rules" warrants TDD, create a TDD plan for it. See `test-claude/get-shit-done/references/tdd.md` for TDD plan structure.
</task_quality>
