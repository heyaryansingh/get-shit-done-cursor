...
@test-claude/get-shit-done/references/principles.md
@test-claude/get-shit-done/references/questioning.md
@test-claude/get-shit-done/templates/project.md
@test-claude/get-shit-done/templates/config.json
...
Present completion with next steps (see test-claude/get-shit-done/references/continuation-format.md):
