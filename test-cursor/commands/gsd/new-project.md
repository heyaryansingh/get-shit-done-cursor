...
@test-cursor/get-shit-done/references/principles.md
@test-cursor/get-shit-done/references/questioning.md
@test-cursor/get-shit-done/templates/project.md
@test-cursor/get-shit-done/templates/config.json
...
Present completion with next steps (see test-cursor/get-shit-done/references/continuation-format.md):
