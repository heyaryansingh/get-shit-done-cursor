...
<references>
@test-cursor/get-shit-done/references/debugging/debugging-mindset.md
@test-cursor/get-shit-done/references/debugging/hypothesis-testing.md
@test-cursor/get-shit-done/references/debugging/investigation-techniques.md
@test-cursor/get-shit-done/references/debugging/verification-patterns.md
@test-cursor/get-shit-done/references/debugging/when-to-research.md
</references>

<template>
@test-cursor/get-shit-done/templates/DEBUG.md
</template>
