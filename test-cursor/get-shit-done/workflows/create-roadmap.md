...
1. test-cursor/get-shit-done/templates/roadmap.md
2. test-cursor/get-shit-done/templates/state.md
...
```bash
ls test-cursor/skills/expertise/ 2>/dev/null
```
...
Use template from `test-cursor/get-shit-done/templates/roadmap.md`.
...
Use template from `test-cursor/get-shit-done/templates/state.md`.
